    ...
    <div className="relative h-[80vh] bg-gradient-to-br from-stone-50 to-neutral-100 overflow-hidden">
      ...
      initial={{ opacity: 0, }}
        ...
        <Image
          ...
          width={800}
          height={800}
          className="object-contain w-[30vw] h-[30vw] blur-md"
        />
      </motion.div>
      <motion.div 
      initial={{ opacity: 0, }}
            animate={{ opacity: 1}}
            transition={{ duration: 0.8, delay: 0.5}} className="absolute bottom-20 left-10 opacity-15">
        <Image
          src="/palm2.png"
          alt=""
          width={1000}
          height={1000}
          className="object-contain w-[80vw] h-[80vw] blur-md"
        />
      </motion.div>
